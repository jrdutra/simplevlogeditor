  ...
  template: `
    <app-help-panel kind="about" label="About">
      <div class="instrucoes">
        ...
        <p>
          <a class="sobre-link sobre-link--github" href="https://github.com/jrdutra/simplevlogeditor"
            ...
            <strong>github.com/jrdutra/simplevlogeditor</strong>
            <em>The project repository — source, issues and releases</em>
          </a>
        </p>
